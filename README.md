...
about the book
Kotlin in Action teaches you to use thetlin language for production-quality applications. Written for expienced Java developers,s example-rich book goes further th most language books, covering interestintopicle bug Dsith natural language syntax. The authors are core Kotlin developers, so you can trust that en t gnarly dere 

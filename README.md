...
about the book
Kotlin in Action teaches you to use thetlin language for production-quality applications. Written for expienced Java developers, this example-rich book goes further th most language books, covering interestintopicle bug DSLsith natural language syntax. The authors are core Kotlin developers, so you can trust that even t gnarly dere de
